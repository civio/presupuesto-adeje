...
MAIN_ENTITY_WEB_URL = 'http://www.adeje.es/'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_LEGAL_URL = 'http://www.adeje.es/aviso-legal'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_PRIVACY_URL = 'http://www.adeje.es/proteccion-de-datos'
